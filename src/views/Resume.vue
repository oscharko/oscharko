    ...
    <div class="entry-content">
      <div class="row">
          ...
          <div class="timeline clearfix">
            ...
            <div class="timeline-item clearfix">
              ...
              <span class="item-company"
                >Dürr Systems GmbH / R&amp;D Projects</span
              >
        ...
        <div class="col-xs-12 col-sm-5">
          ...
          <a
            href="./img/certificate/AWS–dein-weg-zum-zertifizierten-amazon-solutions-architekt-001.webp"
            class="lightbox"
          >
          ...
          <a
            href="./img/certificate/machine-learning-for-data-science-using-MATLAB-001.webp"
            class="lightbox"
          >
            <div class="certificate-item clearfix">
              <div class="certi-logo">
          ...
          <a
            href="./img/certificate/math-works-statistische-methoden-001.webp"
            class="lightbox"
          >
            <div class="certificate-item clearfix">
              <div class="certi-logo">
          ...
          <a
            href="./img/certificate/math-works-data-processing-and-visualization-001.webp"
            class="lightbox"
          >
            <div class="certificate-item clearfix">
              <div class="certi-logo">
          ...
          <a
            href="./img/certificate/big-data-analytics-001.webp"
            class="lightbox"
          >
            <div class="certificate-item clearfix">
              <div class="certi-logo">
          ...
          <a
            href="./img/certificate/acatec-industrie-4.0-001.webp"
            class="lightbox"
          >
            <div class="certificate-item clearfix">
              <div class="certi-logo">
